    ...
    console.log("flckty",flckty)
      ...
      $carousel.on("scroll.flickity", function () {
        ...
        flckty.slides.forEach(function (slide, i) {
          var img = $imgs[i];
          var carouselCover = document.querySelector(".carousel-cover");
          var $SlideWidth = parseFloat(getComputedStyle(carouselCover).width) + 52;
          ...
          console.log("extraWindowSpace",$extraWindowSpace,vw,w2,w3);

          var $slideOffset = jQuery(slide.cells[0].element).offset().left;
          console.log("slideOffset",slide)
